...
import com.enrico.launcher3.accessibility.DragAndDropAccessibilityDelegate;
import com.enrico.launcher3.accessibility.FolderAccessibilityHelper;
...
import com.enrico.launcher3.util.CellAndSpan;
import com.enrico.launcher3.util.GridOccupancy;
import com.enrico.launcher3.util.ParcelableSparseArray;
...
public class CellLayout extends ViewGroup implements BubbleTextShadowHandler {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDragOutlinePaint.setColor(ContextCompat.getColor(context, R.color.outline_color));
        ...
        if (mIsDragOverlapping != isDragOverlapping) {
            ...
            if (mIsDragOverlapping) {
                ...
                if (mBackgroundAlpha > 0f) {
                    mBackground.reverseTransition(0);
                } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mFolderBackgrounds.size(); i++) {
            ...
            bg.drawBackground(mLauncher, canvas, mFolderBgPaint);
            if (!bg.isClipping) {
                bg.drawBackgroundStroke(mLauncher,canvas, mFolderBgPaint);
            }
            canvas.restore();
        }
    ...
    private class ReorderPreviewAnimation {
        ...
        ReorderPreviewAnimation(View child, int mode, int cellX0, int cellY0, int cellX1,
