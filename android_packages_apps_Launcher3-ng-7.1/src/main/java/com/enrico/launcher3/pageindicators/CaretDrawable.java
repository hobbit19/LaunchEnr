...
public class CaretDrawable extends Drawable {
    ...
    public CaretDrawable(Context context) {
        ...
        int color = ContextCompat.getColor(context, R.color.all_apps_caret_color);
        mCaretPaint.setColor(color);
        ...
        mShadowPaint.setColor(ContextCompat.getColor(context, R.color.all_apps_caret_shadow_color));
