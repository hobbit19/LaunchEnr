...
public class InvariantDeviceProfile {
     ...
     */
    @Deprecated
    private int minAllAppsPredictionColumns;
    ...
    private InvariantDeviceProfile(String n, float w, float h, int r, int c, int fr, int fc, int maapc,
    ...
    private ArrayList<InvariantDeviceProfile> getPredefinedDeviceProfiles(Context context) {
    ...
    private ArrayList<InvariantDeviceProfile> findClosestDeviceProfiles(
    ...
    // Package private visibility for testing.
    private InvariantDeviceProfile invDistWeightedInterpolate(float width, float height,
                                                              ArrayList<InvariantDeviceProfile> points) {

        // Constants that affects the interpolation curve between statically defined device profile
        // buckets.
        float KNEARESTNEIGHBOR = 3;
        float WEIGHT_POWER = 5;
    ...
    private float weight(float x0, float y0, float x1, float y1, float pow) {
        ...
        float WEIGHT_EFFICIENT = 100000f;
