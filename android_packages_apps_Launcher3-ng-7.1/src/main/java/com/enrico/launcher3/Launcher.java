...
import com.enrico.launcher3.allapps.PredictiveAppsProvider;
...
import com.enrico.launcher3.customsettings.CustomSettings;
import com.enrico.launcher3.customsettings.SettingsActivity;
...
public class Launcher extends Activity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.enrico.launcher3.intent.extra.shortcut.IGNORE_LAUNCH_ANIMATION";

    public static final String ACTION_APPWIDGET_HOST_RESET =
            "com.enrico.launcher3.intent.ACTION_APPWIDGET_HOST_RESET";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accentColor = Utilities.getColorAccent(this);
    ...
    public static void mustRecreate() {
        recreate = true;
    }
    ...
    private void loadExtractedColorsAndColorItems() {
        // TODO: do this in pre-N as well, once the extraction part is complete.
            ...
            activateLightNavigationBar(isAllAppsVisible());
    }
    ...
    public void activateLightStatusBar(boolean activate) {
        ...
        boolean lightStatusBar = activate || (Utilities.areLightBarsEnabled(this)
    ...
    @TargetApi(26)
    public void disableLightNavigationBar(boolean isDarkTheme) {
        ...
        switch (requestCode) {
            case PermissionUtils.CONTACT_REQUEST_CODE: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, this.getString(R.string.contactsPermissionGranted), Toast.LENGTH_SHORT)
                            .show();
                    ...
                    Toast.makeText(this, this.getString(R.string.contactsPermissionDenied), Toast.LENGTH_SHORT)
                            .show();
            ...
            case PermissionUtils.CALL_REQUEST_CODE:
                if (grantResults.length > 0
                    ...
                    Toast.makeText(this, getString(R.string.phonePermissionGranted), Toast.LENGTH_SHORT)
                            .show();

                } else {

                    Toast.makeText(this, getString(R.string.phonePermissionDenied), Toast.LENGTH_SHORT)
                            .show();
                }
                break;
        }
    ...
    protected void onResume() {
        ...
        //check the state of notification badge service, if this returns false the start notification badge service
        if (NotificationUtils.isNotificationServiceEnabled(this) && !NotificationsDotListener.isServiceRunning) {
            Intent notificationServiceIntent = new Intent(this, NotificationsDotListener.class);
        ...
        if (getWindow().getNavigationBarColor() != Color.TRANSPARENT) {
            Launcher.this.getWindow().setNavigationBarColor(Color.TRANSPARENT);
        }

        if (android.os.Build.VERSION.SDK_INT < 23 && getWindow().getStatusBarColor() != Color.TRANSPARENT) {
            Launcher.this.getWindow().setStatusBarColor(Color.TRANSPARENT);
        }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus && this.isAppsViewVisible()) {
            AllAppsTransitionController.colorNavigationBar(this, true);
    ...
    private void initBoard() {
        ...
        mNotesAdd.setOnClickListener(new OnClickListener() {
            @Override
        ...
        ImageButton boardToolbar = findViewById(R.id.back);

        boardToolbar.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                GesturesUtils.openOrCloseBoard(Launcher.this, false);
            }
        });

        TextView boardTitle = findViewById(R.id.board_title);

        boardTitle.setText(BoardTitleUtils.getBoardTitle(this));
    }
    ...
    private void initContacts() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
                PermissionUtils.requestPermissionWithRationale(this, PermissionUtils.CONTACT_REQUEST_CODE);
    ...
    private void showBrokenAppInstallDialog(final String packageName,
        ...
        new AlertDialog.Builder(this)
            ...
            .setNeutralButton(R.string.abandoned_clean_this,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        final UserHandle user = UserHandleUtil.myUserHandle();
    ...
    public boolean startActivitySafely(View v, Intent intent, ItemInfo item) {
        ...
        try {
            ...
            } else if (user == null || user.equals(UserHandleUtil.myUserHandle())) {
                // Could be launching some bookkeeping activity
                startActivity(intent, optsBundle);
    ...
    public void startEdit(final ItemInfo info, final ComponentName component) {
        ...
        Bitmap defaultIcon =  IconUtils.getEditIconBitmap(this, mIconCache, app, info);
        final Drawable icon = new BitmapDrawable(getResources(), defaultIcon);
