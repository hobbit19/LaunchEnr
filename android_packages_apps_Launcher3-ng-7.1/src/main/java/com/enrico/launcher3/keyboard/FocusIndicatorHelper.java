 ...
 */
abstract class FocusIndicatorHelper implements
        OnFocusChangeListener, AnimatorUpdateListener {

    private static final float MIN_VISIBLE_ALPHA = 0.2f;
    private static final long ANIM_DURATION = 150;

    private static final Property<FocusIndicatorHelper, Float> ALPHA =
    ...
    private static final Property<FocusIndicatorHelper, Float> SHIFT =
    ...
    FocusIndicatorHelper(View container) {
        mContainer = container;

        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        int color = ContextCompat.getColor(container.getContext(), R.color.focused_background);
    ...
    private class ViewSetListener extends AnimatorListenerAdapter {
        ...
        ViewSetListener(View v, boolean callOnCancel) {
            mViewToSet = v;
