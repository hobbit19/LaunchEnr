...
class ClippedFolderIconLayoutRule implements FolderIcon.PreviewLayoutRule {

    static final int MAX_NUM_ITEMS_IN_PREVIEW = 4;
    private static final int MIN_NUM_ITEMS_IN_PREVIEW = 2;

    private final float MIN_SCALE = 0.48f;
    private final float MAX_SCALE = 0.58f;
    private final float MAX_RADIUS_DILATION = 0.15f;
    private final float ITEM_RADIUS_SCALE_FACTOR = 1.33f;
