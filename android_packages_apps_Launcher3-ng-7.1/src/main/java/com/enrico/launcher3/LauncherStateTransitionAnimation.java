...
class LauncherStateTransitionAnimation {
    ...
    static final int BUILD_AND_SET_LAYER = 1;
     ...
     */
    void startAnimationToAllApps(final Workspace.State fromWorkspaceState,
     ...
     */
    void startAnimationToWidgets(final Workspace.State fromWorkspaceState,
