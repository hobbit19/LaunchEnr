...
public class GesturesUtils {
    ...
    public static void openOrCloseBoard(final Launcher mLauncher, boolean show) {
    ...
    static void lockDevice(Launcher mLauncher) {
        ...
        if (isAdmin) {
            ...
            PermissionUtils.requestPermissionWithRationale(mLauncher, PermissionUtils.ADMIN_CODE);
        }
    }
    ...
    static void resolveFlingDownTo(Launcher mLauncher) {
        ...
        switch (Integer.parseInt(choice)) {
            ...
            case FLING_DOWN_BOARD:
                openOrCloseBoard(mLauncher, true);
                break;
    ...
    public static boolean areSimpleGesturesEnabled(Context context) {
        return isFlingDownToSomething(context) || Utilities.isDoubleTapToLockEnabled(context);
    }
}
