...
import com.enrico.launcher3.model.AppNameComparator;
...
class AlphabeticalAppsList {
     ...
     */
    void setNumAppsPerRow(int numAppsPerRow, int numPredictedAppsPerRow,
     ...
     */
    void setPredictedApps(List<ComponentKey> apps) {
    ...
    private void updateAdapterItems() {
        ...
        if (mNumAppsPerRow != 0) {
            ...
            switch (FAST_SCROLL_FRACTION_DISTRIBUTE_BY_NUM_SECTIONS) {
    ...
    static class AdapterItem {
        ...
        static AdapterItem asSectionBreak(int pos, SectionInfo section) {
        ...
        static AdapterItem asPredictedApp(int pos, SectionInfo section, String sectionName,
        ...
        static AdapterItem asApp(int pos, SectionInfo section, String sectionName,
                                 int sectionAppIndex, AppInfo appInfo, int appIndex) {
            AdapterItem item = new AdapterItem();
        ...
        static AdapterItem asPredictionDivider(int pos) {
            AdapterItem item = new AdapterItem();
        ...
        static AdapterItem asSearchDivder(int pos) {
            AdapterItem item = new AdapterItem();
