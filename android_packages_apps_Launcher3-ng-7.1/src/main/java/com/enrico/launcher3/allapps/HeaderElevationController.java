 ...
 */
abstract class HeaderElevationController extends RecyclerView.OnScrollListener {
    ...
    void updateBackgroundPadding(Rect bgPadding) {
    }

    abstract void onScroll(int scrollY);

    static class ControllerVL extends HeaderElevationController {

        private final View mHeader;
        private final float mMaxElevation;
        private final float mScrollToElevation;

        ControllerVL(View header) {
            mHeader = header;
