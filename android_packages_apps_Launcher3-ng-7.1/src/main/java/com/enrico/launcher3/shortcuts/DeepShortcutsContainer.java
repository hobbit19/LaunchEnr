...
import com.enrico.launcher3.LauncherViewPropertyAnimator;
...
public class DeepShortcutsContainer extends LinearLayout implements View.OnLongClickListener,
    ...
    private View addArrowView(int horizontalOffset, int verticalOffset, int width, int height) {
        ...
        int shapeColor = Utilities.isDarkThemeEnabled(getContext()) ? ContextCompat.getColor(getContext(), R.color.material_dark) : ContextCompat.getColor(getContext(), R.color.material_light);
        arrowDrawable.getPaint().setColor(shapeColor);
