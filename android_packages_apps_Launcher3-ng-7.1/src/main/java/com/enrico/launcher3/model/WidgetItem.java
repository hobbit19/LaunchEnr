...
public class WidgetItem extends ComponentKey implements Comparable<WidgetItem> {
    ...
    WidgetItem(LauncherAppWidgetProviderInfo info, AppWidgetManagerCompat widgetManager) {
    ...
    WidgetItem(ResolveInfo info, PackageManager pm) {
    ...
    public int compareTo(@NonNull WidgetItem another) {
        if (sMyUserHandle == null) {
            ...
            sMyUserHandle = UserHandleUtil.myUserHandle();
