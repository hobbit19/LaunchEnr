...
public class FastBitmapDrawable extends Drawable {
    ...
    static final int CLICK_FEEDBACK_DURATION = 2000;
    static final int FAST_SCROLL_INACTIVE_DURATION = 275;
    private static final int FAST_SCROLL_HIGHLIGHT_DURATION = 225;
    private static final int FAST_SCROLL_UNHIGHLIGHT_DURATION = 150;
    private static final int FAST_SCROLL_UNHIGHLIGHT_FROM_NORMAL_DURATION = 225;
     ...
     */
    static int getDurationForStateChange(State fromState, State toState) {
        switch (toState) {
            case NORMAL:
                switch (fromState) {
                    case PRESSED:
     ...
     */
    private static int getStartDelayForStateChange(State fromState, State toState) {
        switch (toState) {
            case FAST_SCROLL_UNHIGHLIGHTED:
                switch (fromState) {
                    case NORMAL:
     ...
     */
    boolean animateState(State newState) {
