...
public class InstallShortcutReceiver extends BroadcastReceiver {
        ...
        if (!installQueue.isEmpty()) {
            ...
            while (iter.hasNext()) {
                ...
                if (!TextUtils.isEmpty(packageName)) {
                    UserHandle myUserHandle = UserHandleUtil.myUserHandle();
    ...
    private static PendingInstallShortcutInfo convertToLauncherActivityIfPossible(
        ...
        if (!Utilities.isLauncherAppTarget(original.launchIntent)
                || !original.user.equals(UserHandleUtil.myUserHandle())) {
    ...
    private static class PendingInstallShortcutInfo {
         ...
         */
        PendingInstallShortcutInfo(Intent data, Context context) {
            this.data = data;
            mContext = context;
         ...
         */
        PendingInstallShortcutInfo(LauncherActivityInfoCompat info, Context context) {
            this.data = null;
            mContext = context;
            activityInfo = info;
            user = info.getUser();
