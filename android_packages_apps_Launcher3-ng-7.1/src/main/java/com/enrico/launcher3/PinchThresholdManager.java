 ...
 */
class PinchThresholdManager {
    static final float THRESHOLD_ONE = 0.40f;
    static final float THRESHOLD_TWO = 0.70f;
    static final float THRESHOLD_THREE = 0.95f;
    private static final float THRESHOLD_ZERO = 0.0f;
    private Workspace mWorkspace;

    private float mPassedThreshold = THRESHOLD_ZERO;

    PinchThresholdManager(Workspace workspace) {
     ...
     */
    float updateAndAnimatePassedThreshold(float progress,
