...
class InverseZInterpolator implements TimeInterpolator {
    ...
    InverseZInterpolator(float foc) {
...
class TransitionStates {
    ...
    TransitionStates(final Workspace.State fromState, final Workspace.State toState) {
 ...
 */
class WorkspaceStateTransitionAnimation {
    ...
    WorkspaceStateTransitionAnimation(Launcher launcher, Workspace workspace) {
        mLauncher = launcher;
    ...
    void snapToPageFromOverView(int whichPage) {
        mWorkspace.snapToPage(whichPage, mOverviewTransitionTime, mZoomInInterpolator);
    }

    AnimatorSet getAnimationToState(Workspace.State fromState, Workspace.State toState,
