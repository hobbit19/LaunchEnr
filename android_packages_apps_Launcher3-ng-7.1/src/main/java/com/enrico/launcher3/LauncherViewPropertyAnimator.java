...
public class LauncherViewPropertyAnimator extends Animator implements AnimatorListener {
    ...
    private EnumSet<Properties> mPropertiesToSet = EnumSet.noneOf(Properties.class);
    ...
    private ArrayList<Animator.AnimatorListener> mListeners = new ArrayList<>();
    ...
    LauncherViewPropertyAnimator withLayer() {
