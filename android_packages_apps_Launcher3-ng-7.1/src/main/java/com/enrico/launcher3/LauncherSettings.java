...
public class LauncherSettings {
    ...
    public static final class WorkspaceScreens implements ChangeLogColumns {
        ...
        static final String TABLE_NAME = "workspaceScreens";
    ...
    public static final class Settings {
        ...
        static final String METHOD_CLEAR_EMPTY_DB_FLAG = "clear_empty_db_flag";
        static final String METHOD_WAS_EMPTY_DB_CREATED = "get_empty_db_flag";

        static final String METHOD_DELETE_EMPTY_FOLDERS = "delete_empty_folders";

        static final String METHOD_NEW_ITEM_ID = "generate_new_item_id";
        public static final String METHOD_NEW_SCREEN_ID = "generate_new_screen_id";

        static final String METHOD_CREATE_EMPTY_DB = "create_empty_db";
        static final String METHOD_DELETE_DB = "delete_db";

        static final String METHOD_LOAD_DEFAULT_FAVORITES = "load_default_favorites";
