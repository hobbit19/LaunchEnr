...
import com.enrico.launcher3.InfoDropTarget;
...
import com.enrico.launcher3.UninstallDropTarget;
...
public class LauncherAccessibilityDelegate extends AccessibilityDelegate implements DragListener {
    ...
    static final int ADD_TO_WORKSPACE = R.id.action_add_to_workspace;
    ...
    private static final int DEEP_SHORTCUTS = R.id.action_deep_shortcuts;
    ...
    final SparseArray<AccessibilityAction> mActions = new SparseArray<>();
    ...
    @Thunk private void announceConfirmation(String confirmation) {
    ...
    private void beginAccessibleDrag(View item, ItemInfo info) {
     ...
     */
    long findSpaceOnWorkspace(ItemInfo info, int[] outCoordinates) {
        Workspace workspace = mLauncher.getWorkspace();
