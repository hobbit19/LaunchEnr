...
import static com.enrico.launcher3.Workspace.State.NORMAL;
import static com.enrico.launcher3.Workspace.State.OVERVIEW;
 ...
 * - At some threshold 1, hotseat fade out (full animation)
...
class PinchAnimationManager {
    ...
    PinchAnimationManager(Launcher launcher) {
        mLauncher = launcher;
    ...
    int getNormalOverviewTransitionDuration() {
     ...
     */
    void animateToProgress(float currentProgress, float toProgress, int duration,
     ...
     */
    void animateThreshold(float threshold, Workspace.State startState,
