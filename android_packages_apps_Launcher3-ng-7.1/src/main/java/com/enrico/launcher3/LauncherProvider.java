...
import com.enrico.launcher3.provider.RestoreDbTask;
import com.enrico.launcher3.util.ManagedProfileHeuristic;
import com.enrico.launcher3.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        Cursor result = qb.query(mOpenHelper.getWritableDatabase(), projection, args.where, args.args, null, null, sortOrder);
    ...
    private DefaultLayoutParser getDefaultLayoutParser(AppWidgetHost widgetHost) {
        ...
        return new DefaultLayoutParser(getContext(), widgetHost,
                mOpenHelper, resources, defaultLayout);
    }
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        void checkId(String table, ContentValues values) {
            long id = values.getAsLong(LauncherSettings.BaseLauncherColumns._ID);
            if (table.equals(WorkspaceScreens.TABLE_NAME)) {
