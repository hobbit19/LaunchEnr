...
public class RandomIconsTile extends TileService {
    ...
    private void applyRandomIcon() {
        ...
        String latestIconPack = Utilities.getPrefs(getBaseContext()).getString(IconUtils.ICON_PACK_PREFERENCE_KEY, "");
        ...
        IconsHandler.switchIconPacks(randomIconPack,getBaseContext());
        Utilities.getPrefs(getBaseContext()).edit().putString(IconUtils.ICON_PACK_PREFERENCE_KEY, randomIconPack).apply();
    }
