...
abstract class SelectableAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    SelectableAdapter() {
        ...
        Set<String> hiddenApps = PreferenceManager.getDefaultSharedPreferences(mContext).getStringSet(BoardUtils.KEY_CUSTOM_APPS_SET, null);
    ...
    void addSelectionsToAppList(Context context) {

        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        prefs.edit().putStringSet(BoardUtils.KEY_CUSTOM_APPS_SET, mSelections).apply();
    }
}