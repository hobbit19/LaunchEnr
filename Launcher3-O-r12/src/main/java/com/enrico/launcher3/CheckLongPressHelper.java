...
public class CheckLongPressHelper {
    ...
    @Thunk private View mView;
    @Thunk private View.OnLongClickListener mListener;
    @Thunk private boolean mHasPerformedLongPress;
    ...
    CheckLongPressHelper(View v, View.OnLongClickListener listener) {
        mView = v;
        mListener = listener;
    }
