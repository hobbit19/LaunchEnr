...
import com.enrico.launcher3.widget.PendingItemDragHelper;
...
public class PinItemDragListener
    ...
    private static final String MIME_TYPE_PREFIX = "com.enrico.launcher3.drag_and_drop/";
    ...
    PinItemDragListener(PinItemRequestCompat request, Rect previewRect,
    ...
    static RemoteViews getPreview(PinItemRequestCompat request) {
