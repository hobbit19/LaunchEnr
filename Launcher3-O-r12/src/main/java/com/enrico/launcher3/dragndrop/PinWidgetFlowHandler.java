 ...
 * the widget is bound.
 */
class PinWidgetFlowHandler extends WidgetAddFlowHandler implements Parcelable {

    private final PinItemRequestCompat mRequest;

    PinWidgetFlowHandler(AppWidgetProviderInfo providerInfo, PinItemRequestCompat request) {
        super(providerInfo);
        mRequest = request;
    }

    private PinWidgetFlowHandler(Parcel parcel) {
        super(parcel);
