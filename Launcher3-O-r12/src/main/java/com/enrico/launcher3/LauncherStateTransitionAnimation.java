...
import com.enrico.launcher3.util.CircleRevealOutlineProvider;
 ...
 */
class LauncherStateTransitionAnimation {
    ...
    @Thunk private AnimatorSet mCurrentAnimation;
    private AllAppsTransitionController mAllAppsController;

    LauncherStateTransitionAnimation(Launcher l, AllAppsTransitionController allAppsController) {
        mLauncher = l;
     ...
     */
    void startAnimationToWidgets(final boolean animated) {
     ...
     */
    void startAnimationToWorkspace(final Launcher.State fromState,
    ...
    @Thunk private void cleanupAnimation() {
        mCurrentAnimation = null;
    }
    ...
    private class StartAnimRunnable implements Runnable {
        ...
        StartAnimRunnable(AnimatorSet anim, View viewToFocus) {
            mAnim = anim;
