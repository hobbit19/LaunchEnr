...
import com.enrico.launcher3.LogDecelerateInterpolator;
...
public class Folder extends AbstractFloatingView implements DragSource, View.OnClickListener,
    ...
    protected void onFinishInflate() {
        ...
        int defaultColor = PreferencesState.isDarkThemeEnabled(mLauncher)? ContextCompat.getColor(mLauncher, R.color.material_dark) : ContextCompat.getColor(mLauncher, R.color.material_light_o);
        int color = PreferencesState.areColoredFoldersEnabled(mLauncher)? ThemeUtils.getColorAccent(mLauncher): defaultColor;
        mFooter.setBackgroundColor(color);

        int textDefaultColor = PreferencesState.isDarkThemeEnabled(mLauncher)? ContextCompat.getColor(mLauncher, R.color.material_light) : ContextCompat.getColor(mLauncher, R.color.material_dark);
        int textColor = PreferencesState.areColoredFoldersEnabled(mLauncher)? defaultColor : textDefaultColor;
