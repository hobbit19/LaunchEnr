...
import com.enrico.launcher3.AllAppsList;
...
public class AddWorkspaceItemsTask extends ExtendedModelTask {
    ...
    private void updateScreens(Context context, ArrayList<Long> workspaceScreens) {
     ...
     */
    private Pair<Long, int[]> findSpaceForItem(
