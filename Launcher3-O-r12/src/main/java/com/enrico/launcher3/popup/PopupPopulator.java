...
import com.enrico.launcher3.notification.NotificationInfo;
import com.enrico.launcher3.notification.NotificationItemView;
import com.enrico.launcher3.notification.NotificationKeyData;
...
public class PopupPopulator {
    ...
    @VisibleForTesting private static final int NUM_DYNAMIC = 2;
    ...
    static @NonNull Item[] getItemsToPopulate(@NonNull List<String> shortcutIds,
    ...
    static Item[] reverseItems(Item[] items) {
    ...
    static Runnable createUpdateRunnable(final Launcher launcher, final ItemInfo originalInfo,
    ...
    private static class UpdateShortcutChild implements Runnable {
        ...
        UpdateShortcutChild(PopupContainerWithArrow container, DeepShortcutView shortcutChild,
    ...
    private static class UpdateNotificationChild implements Runnable {
        ...
        UpdateNotificationChild(NotificationItemView notificationView,
    ...
    private static class UpdateSystemShortcutChild implements Runnable {
        ...
        UpdateSystemShortcutChild(PopupContainerWithArrow container, View systemShortcutChild,
