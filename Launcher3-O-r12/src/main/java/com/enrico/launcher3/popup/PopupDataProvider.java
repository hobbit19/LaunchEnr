...
public class PopupDataProvider implements NotificationListener.NotificationsChangedListener {
    ...
    List<String> getShortcutIdsForItem(ItemInfo info) {
    ...
    @NonNull List<NotificationKeyData> getNotificationKeysForItem(ItemInfo info) {
    ...
    @NonNull List<StatusBarNotification> getStatusBarNotificationsForKeys(
    ...
    @NonNull List<SystemShortcut> getEnabledSystemShortcutsForItem(ItemInfo info) {
