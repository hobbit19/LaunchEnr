...
class PackageInstallerCompatVL extends PackageInstallerCompat {
    ...
    @Thunk private final SparseArray<String> mActiveSessions = new SparseArray<>();

    @Thunk private final PackageInstaller mInstaller;
    ...
    @Thunk private void sendUpdate(PackageInstallInfo info) {
