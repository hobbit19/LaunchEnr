...
import com.enrico.launcher3.allapps.AllAppsBackgroundDrawable;
...
public class DrawableFactory {
    ...
    private final HashMap<UserHandle, Bitmap> mUserBadges = new HashMap<>();

    /**
     * Returns a FastBitmapDrawable with the icon.
     */
    public FastBitmapDrawable newIcon(Context context, Bitmap icon, ItemInfo info) {
        return new FastBitmapDrawable(context,icon);
    }
    ...
    public Drawable getBadgeForUser(UserHandle user, Context context) {
        ...
        FastBitmapDrawable d = new FastBitmapDrawable(context, badgeBitmap);
