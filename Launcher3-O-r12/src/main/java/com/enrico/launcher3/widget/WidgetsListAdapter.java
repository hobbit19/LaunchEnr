...
class WidgetsListAdapter extends Adapter<WidgetsRowViewHolder> {
     ...
     */
    List<WidgetItem> copyWidgetsForPackageUser(PackageUserKey packageUserKey) {
     ...
     */
    private static class WidgetListRowEntryComparator implements Comparator<WidgetListRowEntry> {
