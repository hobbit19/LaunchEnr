    ...
    public void reapplyItemInfo(ItemInfoWithIcon info) {
        ...
        if (mIcon != null) {
            ...
            if (mDisabledForSafeMode) {
                FastBitmapDrawable disabledIcon = drawableFactory.newIcon(getContext(),mIcon, mInfo);
                disabledIcon.setIsDisabled(true);
                mCenterDrawable = disabledIcon;
                mSettingIconDrawable = null;
            } else if (isReadyForClickSetup()) {
                mCenterDrawable = drawableFactory.newIcon(getContext(), mIcon, mInfo);
                mSettingIconDrawable = getResources().getDrawable(R.drawable.ic_settings, getContext().getTheme()).mutate();
