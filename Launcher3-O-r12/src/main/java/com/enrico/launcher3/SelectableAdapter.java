...
abstract class SelectableAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    SelectableAdapter() {
        ...
        Set<String> hiddenApps = PreferenceManager.getDefaultSharedPreferences(mContext).getStringSet(HiddenAppUtils.KEY_HIDDEN_APPS_SET, null);
    ...
    void addSelectionsToHideList(Context context) {
       ...
       prefs.edit().putStringSet(HiddenAppUtils.KEY_HIDDEN_APPS_SET, mSelections).apply();
    }
}