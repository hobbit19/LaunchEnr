...
public class DefaultLayoutParser extends AutoInstallsLayout {
    ...
    @Thunk private HashMap<String, TagParser> getFolderElementsMap(Resources res) {
     ...
     */
    @Thunk private class PartnerFolderParser implements TagParser {
     ...
     */
    @Thunk private class MyFolderParser extends FolderParser {
