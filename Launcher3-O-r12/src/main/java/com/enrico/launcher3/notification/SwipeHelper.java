...
class SwipeHelper {
    ...
    private static final float SWIPE_PROGRESS_FADE_END = 0.5f; // fraction of thumbnail width
    ...
    void setDisableHardwareLayers(boolean disableHwLayers) {
     ...
     */
    private void dismissChild(final View view, float velocity, boolean useAccelerateInterpolator) {
     ...
     */
    private void dismissChild(final View animView, float velocity, final Runnable endAction,
     ...
     */
    private void prepareDismissAnimation(View view, Animator anim) {
        // Do nothing
    }
     ...
     */
    private void prepareSnapBackAnimation(View view, Animator anim) {
        // Do nothing
    }
     ...
     */
    private void onDownUpdate(View currView) {
        // Do nothing
    }
     ...
     */
    private void onMoveUpdate(View view, float totalTranslation, float delta) {
        // Do nothing
    }
