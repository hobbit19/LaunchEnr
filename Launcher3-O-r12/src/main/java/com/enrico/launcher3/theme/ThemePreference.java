...
public class ThemePreference extends Preference {
    ...
    private static int resolveColor(int pos) {
        ...
        int deep_purple = R.color.material_deep_purple_400;
        int indigo = R.color.material_indigo_400;
        int blue = R.color.material_blue_400;
        int light_blue = R.color.material_light_blue_400;
        ...
        int deep_orange = R.color.material_deep_orange_400;
        int brown = R.color.material_brown_400;
        int blue_grey = R.color.material_blue_grey_400;
