 ...
 */
public abstract class ButtonDropTarget extends ImageButton
    ...
    public ButtonDropTarget(Context context, AttributeSet attrs, int defStyle) {
        ...
        mOriginalButtonColor = Utilities.getComplementaryColor(ThemeUtils.getColorAccent(context));

        mHoverColor = PreferencesState.isDarkThemeEnabled(context)? ContextCompat.getColor(mLauncher, R.color.trans_material_dark_default) : ContextCompat.getColor(mLauncher, R.color.trans_material_light_o);
    ...
    protected void setDrawable(int resId) {
        ...
        mDrawable = getResources().getDrawable(resId, mContext.getTheme());
