...
public class LauncherScroller  {
     ...
     */
    LauncherScroller(Context context) {
        this(context, null);
    }
     ...
     */
    private LauncherScroller(Context context, Interpolator interpolator) {
     ...
     */
    private LauncherScroller(Context context, Interpolator interpolator, boolean flywheel) {
        mFinished = true;
        mInterpolator = interpolator;
     ...
     * @see #setFinalY(int)
     */
    private void extendDuration(int extend) {
     ...
     * @see #setFinalX(int)
     */
    private void setFinalY(int newY) {
        mFinalY = newY;
