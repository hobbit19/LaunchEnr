...
import com.enrico.launcher3.allapps.AlphabeticalAppsList.AdapterItem;
...
class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    static final int VIEW_TYPE_APPS_LOADING_DIVIDER = 1 << 8;
    ...
    private static final int VIEW_TYPE_MASK_CONTENT = VIEW_TYPE_MASK_ICON;
