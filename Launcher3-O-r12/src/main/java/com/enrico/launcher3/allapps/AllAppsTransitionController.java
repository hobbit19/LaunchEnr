...
public class AllAppsTransitionController implements TouchController, VerticalPullDetector.Listener,
    ...
    private void updateLightStatusBar(float shift) {
        ...
        boolean forceLight = !PreferencesState.isDarkThemeEnabled(mLauncher) && shift <= mStatusBarHeight / 2;
        ...
        animationOut.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (canceled) {
                    ...
                    if (PreferencesState.isDarkThemeEnabled(mLauncher.getBaseContext()) && PreferencesState.isLightStatusBarPrefEnabled(mLauncher.getBaseContext())) {
                        mLauncher.disableLightStatusBar();
                        mLauncher.disableLightNavigationBar();
                    }
    ...
    public static void colorStatusBarPreMarshmallow(Activity activity, boolean isColored) {
        ...
        boolean isDarkTheme = PreferencesState.isDarkThemeEnabled(activity);
