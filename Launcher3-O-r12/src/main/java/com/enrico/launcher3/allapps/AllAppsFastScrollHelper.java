...
class AllAppsFastScrollHelper implements AllAppsGridAdapter.BindViewCallback {
    ...
    @Thunk private String mCurrentFastScrollSection;
    @Thunk private String mTargetFastScrollSection;
    ...
    @Thunk private int mFastScrollFrameIndex;
    @Thunk private final int[] mFastScrollFrames = new int[10];

    /**
     * This runnable runs a single frame of the smooth scroll animation and posts the next frame
     * if necessary.
     */
    @Thunk private Runnable mSmoothSnapNextFrameRunnable = new Runnable() {
        @Override
        public void run() {
     ...
     */
    private Runnable mFastScrollToTargetSectionRunnable = new Runnable() {
        @Override
        public void run() {
    ...
    AllAppsFastScrollHelper(AllAppsRecyclerView rv, AlphabeticalAppsList apps) {
        mRv = rv;
        mApps = apps;
    }

    void onSetAdapter(AllAppsGridAdapter adapter) {
     ...
     */
    boolean smoothScrollToSection(int scrollY, int availableScrollHeight,
